                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          ...
                          onClick={() =>
                            router.push(
                              `/mentor/quizlets/${quizlet.id}?data=${encodeURIComponent(JSON.stringify(quizlet))}`,
                            )
                          }
                        >
                          Xem
                        ...
                        <Button
                          ...
                          onClick={() =>
                            router.push(
                              `/mentor/quizlets/${quizlet.id}/edit?data=${encodeURIComponent(JSON.stringify(quizlet))}`,
                            )
                          }
                        >
                          Sửa
