...
{
    public async Task<ServiceResponse<string>> Handle(Command.ApproveEnrollmentCommand request,
        CancellationToken cancellationToken)
    {
        ...
        await unitOfWork.ExecuteInTransactionAsync(async ct =>
        {
            ...
            {
                resultResponse = new ServiceResponse<string>(false, "Enrollment not found.", null, null, true,
            ...
            {
                resultResponse = new ServiceResponse<string>(false,
                    $"Cannot approve enrollment with status: {enrollment.Status}", null, null, false, "INVALID_STATUS");
                return;
            }
            ...
            if (lockedCourse is null)
            {
                resultResponse =
                    new ServiceResponse<string>(false, "Course not found.", null, null, true, "COURSE_NOT_FOUND");
                return;
            }
            ...
            if (lockedCourse.CurrentEnrollment >= lockedCourse.MaxCapacity)
            {
                ...
                resultResponse = new ServiceResponse<string>(false,
                    "Course is already at maximum capacity. Enrollment rejected automatically.", null, null, false,
                    "COURSE_FULL");
                return;
            }
        ...
        return resultResponse ?? new ServiceResponse<string>(false, "An error occurred while approving enrollment.",
            null, null, false, "SYSTEM_ERROR");
    }
}
